...
.. |link_openai_platform| raw:: html
    ...
    <a href="https://platform.openai.com/api-keys" target="_blank">Piattaforma OpenAI</a>
...
.. |link_Pi_Crawler| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/picrawler-robot-kit?_pos=1&_sid=2ebeb7ad0&_ss=r" target="_blank">Link per l'acquisto di PiCrawler</a>
